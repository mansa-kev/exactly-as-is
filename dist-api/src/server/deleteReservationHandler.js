...
export function createDeleteReservationHandler(supabase) {
        ...
        try {
            ...
            if (reservation.car_id) {
                await supabase
                    ...
                    .then(null, (err) => console.warn('[delete-reservation] car status:', err?.message));
            }
            if (reservation.client_id) {
                await supabase
                    ...
                    .then(null, (err) => console.warn('[delete-reservation] notification:', err?.message));
            }
