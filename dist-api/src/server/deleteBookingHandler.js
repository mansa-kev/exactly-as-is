...
export function createDeleteBookingHandler(supabase, requireServiceRole = true) {
            ...
            if (requireServiceRole) {
                ...
                if (!serviceKey) {
                    return res.status(503).json({
                        success: false,
                        error: 'Server misconfiguration: SUPABASE_SERVICE_ROLE_KEY is required on Vercel for booking deletion.',
                    });
                }
            }
            const relatedTables = [
