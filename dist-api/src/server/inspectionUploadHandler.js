...
async function canUploadInspection(supabase, userId, bookingId) {
...
function sanitizeFilePath(bookingId, requestedPath) {
...
export function createInspectionUploadHandler(supabase, requireServiceRole = true) {
